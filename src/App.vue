    ...
    <div class="scroll">
      <div class="border">
        ...
        <Transition enter-active-class="animate__animated animate__fadeIn animate__delay-2s animate__slower" 
                    leave-active-class="animate__animated animate__fadeOut" 
                    mode="out-in" appear>
          <CreepyText :texts="bestPost.texts" :link="bestPost.link"></CreepyText>
        </Transition>
      </div>
  ...
  data(){
    return{
      ...
      bestPost:{
        ...
        link: 'https://creepypasta.fandom.com/wiki/The_Rake',
        texts: ['During the summer of 2003, events in the northeastern United States involving a strange, human-like creature sparked brief local media interest before an apparent blackout was enacted. Little or no information was left intact, as most online and written accounts of the creature were mysteriously destroyed.',
